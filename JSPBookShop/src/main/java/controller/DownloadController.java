...
@WebServlet("/JSPBookShop/download.do")
public class DownloadController extends HttpServlet {
	// 파일 다운로드 경로
	private static final String FILES_DIR = "/upload";
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		// boardDetail.jsp 또는 boardList.jsp 페이지에서 넘겨주는 매개변수를 각 변수에 저장
		// download.do?ofile=${ board.ofile }&sfile=${ board.sfile }&boardID=${ board.boardID }
